        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailCheck", "Email LIKE '%_@_%.__%'");
                    table.CheckConstraint("PhoneCheck", "LEN(Phone) = 11 AND Phone LIKE '01[0125][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Traineers", x => x.Id);
                    table.CheckConstraint("EmailCheck1", "Email LIKE '%_@_%.__%'");
                    table.CheckConstraint("PhoneCheck1", "LEN(Phone) = 11 AND Phone LIKE '01[0125][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sessions_Traineers_TraineerId",
                        column: x => x.TraineerId,
                        principalTable: "Traineers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
